...
class Int {
    constructor() {
        this.base = 10;
        this.width = Math.ceil(32 / Math.log2(this.base)); // 10^x>=2^32となる最小のx
    ...
    add_int(pos_from, pos_tos, hm, mm) {
        let restore = hm.getHead();
    ...
    copy_int(pos_from, pos_tos, hm, mm) {
        let restore = hm.getHead();
        //let req = mm.require(this.len);
        //req = 48;
        let res = '';
    ...
    move_int(pos_from, pos_tos, hm, mm) {
        let restore = hm.getHead();
        let res = '';
        // pos_tosを0初期化
        pos_tos.forEach((v) => {
